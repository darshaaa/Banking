...
export default function NewLoanApplication() {
  return (
    <div className="flex h-screen bg-indigo-200 overflow-hidden">
      {/* 1. Sidebar is now imported and placed here */}
      <Sidebar />
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="bg-slate-100 px-3 py-1 rounded text-[10px] font-bold text-slate-500 uppercase">
            App ID: #TEMP-2025-001
          </div>
        </div>
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-[2.5] space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <input type="text" defaultValue="M-10042" className="flex-1 border border-slate-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0047AB]/10" />
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                <div className="space-y-2">
                  ...
                  <input type="text" readOnly value="Gold Loan (Secured)" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-sm text-slate-600 font-medium cursor-not-allowed" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Interest Rate (p.a)</label>
                  <input type="text" readOnly value="12.00%" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-sm text-slate-600 font-medium cursor-not-allowed" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Requested Amount (₹)</label>
                  <input type="text" defaultValue="100000" className="w-full border border-blue-200 rounded-lg px-4 py-2 text-sm text-[#0047AB] font-bold focus:outline-none" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tenure (Months)</label>
                  <input type="text" defaultValue="12" className="w-full border border-slate-200 rounded-lg px-4 py-2 text-sm focus:outline-none" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <input type="text" placeholder="Enter ID..." className="flex-1 border border-slate-200 rounded-lg px-4 py-2 text-sm focus:outline-none" />
                  <button className="border border-slate-200 px-4 py-2 rounded-lg text-xs font-bold hover:bg-slate-50">Check Eligibility</button>
                </div>
          ...
          {/* Right Column: Blue Summary Card */}
